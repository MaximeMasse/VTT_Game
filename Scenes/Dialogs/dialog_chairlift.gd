...
func dico_update():
	dico_dialogs = {
		"tuto":{
			...
			"acts":[
				"anim_Char2_arrive",
				"dialog_char1_Hey, Hi back     .......\n\n"+
				"Ermmm, what's your name already ? Personnaly, people calls me [color=pink]Biqueen[/color] around here.",
				"dialog_char2_Glad to meet you Biqueen, I'm [wave][color=silver]" + Global.current_profile["name"] + "[/color][/wave] by the way",
				"dialog_char1_Alright, well, as you're a newcomer, let's start off with a simple track, just to see how to ride the place.",
				"dialog_char1_Follow me toward the so called 'Map 0', also know as the Noob Track.\n\n"+
				"But maybe, you should come back with a bike [wave][color=silver]" + Global.current_profile["name"] + "[/color][/wave].",
				"anim_Char1_leave",
				"dialog_char2_Ok, let's get my [color=red]beautiful ride[/color] and impress her !",
