...
@export var road_texture:=preload("res://Images/Mapping/Textures/terre_1.png")
@export var road_width := 50.0
@export var visual_step := 6.0
@export var texture_repeat_px := 50.0
