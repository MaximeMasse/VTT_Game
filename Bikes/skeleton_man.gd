...
var rest_position := Vector2(-13,-5)
var rest_rotation := deg_to_rad(0)
var back_position := Vector2(-31,11)
var back_rotation := deg_to_rad(8)
var front_position := Vector2(24,-9)
var front_rotation := deg_to_rad(7)
var leaning_speed := 0.1
var leaning_return_speed := 0.8
var low_position := Vector2(2,11)
var low_rotation := deg_to_rad(7)
var high_position := Vector2(-1,-24)
var high_rotation := deg_to_rad(0)
